$(document).ready(function () {
    ...
    function view_categories() {
        ...
        $.ajax({
            ...
            type: "GET",
            url: 'http://mezz.ir/phoenix/app/api/App/categories.php',
            dataType: 'json',
    ...
    function view_most_downloads() {
        ...
        $.ajax({
            ...
            type: "GET",
            url: 'http://mezz.ir/phoenix/app/api/App/most_download.php',
            dataType: 'json',
            success: function (data) {
                // console.log(data);
    ...
    function view_most_points() {
        ...
        $.ajax({
            ...
            type: "GET",
            url: 'http://mezz.ir/phoenix/app/api/App/most_points.php',
            dataType: 'json',
            success: function (data) {
                //console.log(data);
